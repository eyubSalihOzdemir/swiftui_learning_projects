        ...
        NavigationView {
            List {
                ForEach(filteredProspects) { prospect in
                    ...
                    .confirmationDialog("How do you want to sort the contacts?", isPresented: $isShowingConfirmationDialog) {
                        Button("Name") {
                            prospects.changeSorting(to: .name)
                        }

                        Button("Most Recent") {
                            prospects.changeSorting(to: .recent)
                        }
                    }
                }
            }
